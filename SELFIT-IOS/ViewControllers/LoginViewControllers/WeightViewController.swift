...
class WeightViewController: UIViewController {
    ...
    let selectHintLabel: UILabel = {
        let label = UILabel()
        label.text = "(Select weight in KG(s))"
    ...
    override func viewDidLoad() {
        ...
        registerDataManager.registerModel.weight = 74
        ...
        if let selectedIndex = data.firstIndex(of: 74) {
    ...
    @objc func nextTapped(){
        ...
        navigateToViewController(ExerciseTypeViewController(), from: self.navigationController)
    }
}
...
extension WeightViewController: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        registerDataManager.registerModel.weight = data[row]
    }
